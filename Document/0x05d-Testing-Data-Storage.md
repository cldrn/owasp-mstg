...
It is important to check for both keywords `textNoSuggestions` and `InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS` as the input type can also be changed dynamically from an Activity.
